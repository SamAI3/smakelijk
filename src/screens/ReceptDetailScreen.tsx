...
export default function ReceptDetailScreen({ recept, onBack, onEdit }: Props) {
  ...
  const toggleFavoriet = () => {
    updateRecept(recept.id, { favoriet: !recept.favoriet });
  };
  ...
  if (kookModus) {
    return (
      <div style={{
        ...
        overflowY: 'auto', zIndex: 100, padding: '24px 20px 48px',
      }}>
        <button
          onClick={() => setKookModus(false)}
          style={{
            display: 'flex', alignItems: 'center', gap: 8,
            color: '#A09A93', marginBottom: 24, fontSize: 14,
          }}
        >
          <ArrowLeft size={18} /> Afsluiten
        </button>
        <h1 style={{ fontFamily: 'var(--font-title)', fontSize: 28, marginBottom: 24 }}>
          {recept.titel}
        </h1>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          {recept.bereiding.map((stap, i) => (
            <div key={i} style={{ display: 'flex', gap: 16 }}>
              ...
              <p style={{ fontSize: 18, lineHeight: 1.6, color: '#FAF6F0', marginTop: 4 }}>{stap}</p>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <div style={{ flex: 1, overflowY: 'auto', background: 'var(--bg)' }}>
      {/* Header */}
      <div style={{
        background: 'var(--card)', padding: '16px 20px 20px',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
          ...
          <button
            ...
            style={{ display: 'flex', color: 'var(--accent1)' }}
          >
            <Trash2 size={20} />
          </button>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <button
            ...
            style={{
              ...
              background: 'rgba(45,42,38,0.06)', display: 'flex',
      ...
      <div style={{ padding: '8px 20px 40px', display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        {recept.ingredienten.length > 0 && (
          <section>
            <h2 style={{ fontFamily: 'var(--font-title)', fontSize: 20, marginBottom: 12 }}>
              Ingrediënten
            </h2>
            <div style={{
                ...
                <div
                  ...
                  style={{
                    ...
                    borderBottom: i < recept.ingredienten.length - 1
                      ? '1px solid rgba(45,42,38,0.06)' : 'none',
                  }}
                >
        ...
        {recept.notities && (
          <section>
            ...
            <div style={{
              ...
              fontSize: 14, lineHeight: 1.6, color: '#5A554F',
            }}>
              {recept.notities}
            </div>
          </section>
        ...
        {recept.bronUrl && (
          <a
            ...
            style={{
              ...
              color: 'var(--accent5)', fontSize: 13, fontWeight: 500,
            }}
          >
